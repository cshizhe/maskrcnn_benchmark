...
# Box Attribute prediction
_C.MODEL.ROI_ATTR_HEAD = CN()
_C.MODEL.ROI_ATTR_HEAD.PREDICTOR = 'AttrFPNPredictor'
_C.MODEL.ROI_ATTR_HEAD.NUM_ATTR_CLASSES = 401
_C.MODEL.ROI_ATTR_HEAD.OBJ_EMBED_SIZE = 256
_C.MODEL.ROI_ATTR_HEAD.ATTR_HIDDEN_SIZE = 512
